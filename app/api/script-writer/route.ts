...
- script 欄位請嚴格依下列 9 個 Markdown 小標，依序各出現一次；前 8 個是口播段落，「定位管理確認」不是口播：
## ▌生活場景
## ▌本人經歷與困境
## ▌嘗試與意外結果
## ▌得到的認知
...
## ▌金句收束
## ▌定位管理確認
- 「生活場景」同時就是 Hook：從一個台灣上班族一眼能認出的具體時刻切入，立即建立衝突，說清楚與觀眾的關係及看完的價值；不要先自我介紹、先講品牌定位或先解釋術語。
- 「本人經歷與困境」選用最相關的真實故事，呈現當時的限制、選擇與代價，不要只摘要年份與成果；頻道定位與「管理現金流｜降低薪水依賴｜拿回人生選擇權」應自然融入經歷、認知或收束，不另設定位宣告段。
- 「嘗試與意外結果」必須寫出米克實際做了什麼，以及真實結果和原先預期有何落差；意外可以是已知結果或認知反差，但不能硬編事件、對話、情緒或因果。沒有適合的故事結果時，坦白使用可支持的生活矛盾，不補造第一人稱經歷。
- 「得到的認知」只說清楚本集的一個核心觀念，必須由前段經歷推導出來，不突然變成抽象教學。
- 「具體例子」用生活場景、已提供的案例或可核實數字把觀念講透；不要只列名詞、步驟或口號，也不要重複前段故事。
- 「觀眾如何判斷」提供 2–3 個清楚的判斷問題或標準，讓觀眾能對照自己的處境，不替觀眾武斷下結論。
- 「最小行動」只給一個今天可以完成的動作，具體到觀眾知道要拿出什麼、檢查什麼或寫下什麼；不要塞入多步挑戰。
- 「金句收束」濃縮本集核心，回扣生活場景與品牌定位後自然結束；腳本全文不要加入 CTA、訂閱提醒、留言邀請、下載資源或點擊連結等引導。
- 八段必須形成「場景中的問題→本人如何遭遇→嘗試後的落差→認知轉折→例子驗證→觀眾自我判斷→立即行動→一句話記住」的連續推進，不可把同一個觀念換標題重說。
- 「定位管理確認」不是口播；在此簡短列出本集選用的故事編號、可查證／未查證資訊、核心觀念與最小行動。若故事庫沒有適合素材，寫明「未使用故事庫，不補造個人經歷」。

【資訊欄規格】
- 約 350–600 個繁體中文字。
- 包含本集摘要、觀眾會帶走的 3 點、品牌句與 3–5 個相關 Hashtag；不要加入 CTA、免費工具、下載連結或未確認的網址。
